...
$banner_url = ["mymoney", "mybusiness", "myextras", "apply-now"];
?>
            ...
            <div class="row">
                <div class="categories">
                    <ul class="nav nav-tabs" id="product_and_services" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="mymoney-tab" data-bs-toggle="tab" data-bs-target="#mymoney-tab-pane" type="button" role="tab" aria-controls="mymoney-tab-pane" aria-selected="false">MyMoney</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="mybusiness-tab" data-bs-toggle="tab" data-bs-target="#mybusiness-tab-pane" type="button" role="tab" aria-controls="mybusiness-tab-pane" aria-selected="false">MyBusiness</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="myextras-tab" data-bs-toggle="tab" data-bs-target="#myextras-tab-pane" type="button" role="tab" aria-controls="myextras-tab-pane" aria-selected="false" myextras>MyExtras</button>
                        </li>
                    </ul>
                </div>
                <div class="header">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="all-pane" role="tabpanel" aria-labelledby="all" tabindex="0">
                        <div id="post_carousel" class="owl-carousel owl-theme">
                            <?php
                            global $paged;
                    ...
                    <div class="tab-pane fade" id="mymoney-tab-pane" role="tabpanel" aria-labelledby="mymoney-tab" tabindex="0">
                        <div class="my_money">
                            <div class="row">
                                <?php
                                global $paged;
                                ...
                                $args = array(
                                    ...
                                    'tax_query'      => array(
                                        array(
                                            'taxonomy' => 'product-and-services', // Replace 'category' with your custom taxonomy if applicable
                                            'field'    => 'slug',     // Or 'term_id' if you're using term IDs
                                            'terms'    => 'mymoney',
                                        ),
                                    ),
                                );
                    ...
                    <div class="tab-pane fade" id="mybusiness-tab-pane" role="tabpanel" aria-labelledby="mybusiness-tab" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="myextras-tab-pane" role="tabpanel" aria-labelledby="myextras-tab" tabindex="0">
                ...
                <div class="col-md-12">
                    <div class="content_bg">
                        <div class="main_content">
                            ...
                            <a href="<?php echo get_home_url(); ?>/" target="_blank" rel="noopener noreferrer" class="orange_btn">Calculate Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-12">
                        <div class="content">
                            ...
                            <p>At Bank of Makati, we are committed to providing accessible and personalized banking services. Our goal is to empower individuals and businesses to achieve their financial aspirations through innovative solutions.</p>
                            <div class="counter">
                                <p>Our financial performance at glance:</p>
                            ...
                            <a href="<?php echo get_home_url(); ?>" target="_blank" rel="noopener noreferrer" class="orange_btn">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-5">
                    <div class="content">
                        ...
                        <div class="business_oppurtunities">
                            <img src="<?php echo $img_path; ?>Business Opportunities.gif" alt="Business Opportunities">
                        ...
                        <div class="sustainable_growth">
                            <img src="<?php echo $img_path; ?>Sustainable Growth.gif" alt="Sustainable Growth">
                        ...
                        <div class="empowered_futured">
                            <img src="<?php echo $img_path; ?>Empowered Future.gif" alt="Empowered Future">
                ...
                <div class="col-lg-6">
                    <div class="image">
                        <img src="<?php echo $img_path; ?>Partner with Bank of Makati for Your Financial Success.jpg" alt="Partner with Bank of Makati for Your Financial Success" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-5">
                    <div class="content">
                        ...
                        <p>Have questions or need assistance? Contact us today through our available channels, and we'll be happy to assist you with your banking needs.</p>
                        <div class="group_button">
                            <a href="http://" target="_blank" rel="noopener noreferrer" class="orange_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">Request Online Information</a>
                            <a href="http://" target="_blank" rel="noopener noreferrer" class="transparent_btn">Help Us Improve</a>
                        </div>
                        <div class="head_office">
                            <img src="<?php echo $img_path; ?>Head Office.gif" alt="Head Office">
                        ...
                        <div class="telephone_number">
                            <img src="<?php echo $img_path; ?>Telephone Number.gif" alt="Telephone Number">
                ...
                <div class="col-lg-6">
                    <div class="image">
                        <img src="<?php echo $img_path; ?>Get in Touch with Us.jpg" alt="Get in Touch with Us" class="w-100 img-fluid">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="content_bg">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5" id="exampleModalLabel">Request for Online Information</h3>
