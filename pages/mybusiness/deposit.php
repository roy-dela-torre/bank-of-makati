            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="header">
                        ...
                        <h2 class="text-center">Help Us Get Your Details Right</h2>
                        <p class="text-center">To get started, share a few key business details. This ensures your deposit forms are handled smoothly and without delay.</p>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="forms">
                        <!-- <ul id="progressbar" class="d-flex justify-content-center">
                            <li class="active">Customer Information Form</li>
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="34c48c6" title="My Business Deposit Form"]') ?>
