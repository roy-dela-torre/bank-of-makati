...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/owl.theme.default.min.css">
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/owl.carousel.min.css">
<script src="<?php echo get_stylesheet_directory_uri(); ?>/inc/js/testimonial_carousel.js"></script>
