<?php
function get_branches_ajax()
{
    $term = isset($_POST['term']) ? sanitize_text_field($_POST['term']) : 'regular-branches';
        ...
        <?php if ($query->have_posts()):
            while ($query->have_posts()):
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="content">
                        <div class="maps">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bmi_branch_locator/maps_placeholder.jpg"
                                alt="" class="img-fluid w-100 maps_placeholder">
                            <iframe
                                    ...
                                    <p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="21" viewBox="0 0 12 21" fill="none">
                                            ...
                                            <path
                                                ...
                                                fill="#2F3A5A" />
                                            <g opacity="0.5">
                                                <path d="M9.64494 2.66504L0.96875 17.1809V14.9142L8.28939 2.66504H9.64494Z"
                                                    fill="#E1E6E9" />
                                                <path d="M10.5202 3.36035V4.4921L2.65666 17.6492H1.98047L10.5202 3.36035Z"
                                                    fill="#E1E6E9" />
                                            </g>
                                        </svg>
...
add_action('wp_ajax_get_branches', 'get_branches_ajax');
add_action('wp_ajax_nopriv_get_branches', 'get_branches_ajax');