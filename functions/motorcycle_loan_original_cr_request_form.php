...
function custom_bmi_branch_group_form($tag)
{
    ...
    if (isset($data['bmi_branch']['branches'][$group_key])) {
        $tag['raw_values'][] = '';
        $tag['labels'][] = 'BMI Branches (Required)';
...
function custom_motortrade_dealers_form($tag)
{
    ...
    $groups = [
        ...
        'dealers_metro_manila' => 'Cities Of Metro Manila',
        'dealers_misamis_occidental' => 'Misamis occidental',
        'dealers_misamis_oriental' => 'Mountain province',
        ...
        'dealers_samar' => 'Samar',
        'dealers_sarangani_province' => 'Sarangani',
