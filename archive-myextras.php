            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="header d-flex align-items-center flex-wrap justify-content-between">
                        <h2 class="mb-0">Online Motorcycle Request Form</h2>
                        <a href="<?php echo get_home_url(); ?>/myextras/motorcycle-request-form/" target="_blank" rel="noopener noreferrer" class="blue_btn">Learn More</a>
                    </div>
                </div>
                <?php
                // Define the query arguments
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="header d-flex align-items-center flex-wrap justify-content-between">
                        <h2 class="mb-0">Deposit Rates</h2>
