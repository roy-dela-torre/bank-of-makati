            ...
            <div class="col-lg-4">
              <div class="logo">
                <a href="<?php echo get_home_url(); ?>">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/global/logo.png" alt="" class="img-fluid w-100">
                </a>
              </div>
            </div>
            <div class="col-lg-8">
  ...
  <div class="search_form">
    <form role="search" method="get" class="mb-0" role="search" action="<?php echo esc_url(home_url('/')); ?>">
      <div class="search_field d-flex align-items-center">
        ...
        <input type="search" placeholder="Search" class="w-100" value="<?php echo get_search_query(); ?>" name="s"
          id="s">
      </div>
    </form>
  </div>