        ...
        <div class="container-fluid">
            <div class="row">
                <div class="header mb-0">
                    <h1 class="text-white mb-0 text-center">BMI Branch Locator</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="group_button">
                        <button class="orange_btn active" id="regular_rranches">Regular Branches</button>
                        <button class="transparent_btn" id="microfinance_branches">Microfinance Branches</button>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="header">
                        <div class="left_content">
                            <span class="orange_text">Branches</span>
                            <h2>Find a Bank of Makati Branch Near You</h2>
                            <p>Visit any of our conveniently located branches across the Philippines for personalized
                                banking services.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="maps_list">
                        <div class="row">
                            ...
                            $args = array(
                                ...
                                'tax_query' => array(
                                    array(
                                        'taxonomy' => 'branches', // Replace with the actual taxonomy name
                                        'field' => 'slug',
                                        'terms' => 'regular-branches', // The term you're filtering by
                                        'operator' => 'IN', // Use 'IN', 'NOT IN', 'AND', 'EXISTS', 'NOT EXISTS'
                                    ),
                                ),
                            ...
                            if ($query->have_posts()): ?>
                                <?php while ($query->have_posts()):
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="content">
                                            <div class="maps">
                                                <img src="<?php echo $img_path; ?>/maps_placeholder.jpg" alt=""
                                                    class="img-fluid w-100 maps_placeholder">
                                                ...
                                                if (get_field('maps')) {
                                                    ...
                                                    <iframe
                                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3790.381001975133!2d120.60405720000001!3d18.192407199999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x338ec7655eaea311%3A0x88cb786fcaced8b5!2sNRN%20Apartment%20and%20building!5e0!3m2!1sen!2sph!4v1737011132438!5m2!1sen!2sph"
                                                        width="600" height="450" style="border:0;display: none;" allowfullscreen=""
                                            ...
                                            <div class="main_content">
                                                <h3 class="text-capitalize"><?php echo strtolower(get_the_title()); ?></h3>
                                                <div class="location">
                                                    <?php
                                                        ...
                                                        <p>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23"
                                                                ...
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                                    d="M7.13214 2.5C11.0684 2.5 14.2643 5.70071 14.2643 9.64286C14.2643 11.7529 13.2059 14.2336 11.9057 16.44C10.0199 19.6407 7.66207 22.2636 7.66207 22.2636C7.52727 22.4143 7.33398 22.5 7.13214 22.5C6.9303 22.5 6.73701 22.4143 6.60222 22.2636C6.60222 22.2636 4.24434 19.6407 2.3586 16.44C1.05841 14.2336 0 11.7529 0 9.64286C0 5.70071 3.19591 2.5 7.13214 2.5ZM7.13214 5.35714C4.77069 5.35714 2.85286 7.27786 2.85286 9.64286C2.85286 12.0079 4.77069 13.9286 7.13214 13.9286C9.4936 13.9286 11.4114 12.0079 11.4114 9.64286C11.4114 7.27786 9.4936 5.35714 7.13214 5.35714Z"
                                                                    fill="#0DADF5" />
                                                                <path
                                                                    d="M7.13411 12.5002C8.7097 12.5002 9.98697 11.221 9.98697 9.64303C9.98697 8.06508 8.7097 6.78589 7.13411 6.78589C5.55852 6.78589 4.28125 8.06508 4.28125 9.64303C4.28125 11.221 5.55852 12.5002 7.13411 12.5002Z"
                                                                    fill="#1F397B" />
                                                            </svg>
                                                    ...
                                                    if (have_rows('telephone')) {
                                                        ...
                                                        while (have_rows('telephone')) {
                                                            ...
                                                            if ($telephone) {
                                                                ...
                                                                // Keep the original formatting of the telephone number
                                                                $formatted_telephones[] = '<a href="tel:+' . $telephone_cleaned . '">' . $telephone . '</a>';
                                                            }
                                                        }
                                                        ...
                                                        <p>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21"
                                                                ...
                                                                <path
                                                                    d="M13.761 13.2979L12.824 14.3911C12.0432 15.2656 10.7626 15.3905 9.98177 14.6097L5.85892 10.4868C5.07807 9.70599 5.20301 8.42541 6.07755 7.64457L7.17073 6.67632L1.64236 1.14795C1.51743 1.30412 1.39249 1.42905 1.29879 1.58522C-0.262895 3.45925 -0.512765 6.95742 1.08016 9.20625C3.95366 13.1105 7.38937 16.5462 11.2936 19.4197C13.5424 21.0126 17.0406 20.7627 18.9146 19.201C19.0708 19.0761 19.1957 18.9512 19.3519 18.8262L13.761 13.2979Z"
                                                                    fill="#F1786B" />
                                                                <path
                                                                    d="M2.01543 0.804529L1.64062 1.1481L7.169 6.67647L7.5438 6.30167C7.94984 5.89563 7.94984 5.23972 7.5438 4.80245L3.48342 0.804529C3.07738 0.39849 2.42147 0.39849 2.01543 0.804529Z"
                                                                    fill="#DD655B" />
                                                                <path
                                                                    d="M14.1365 12.9231L13.7617 13.2979L19.2901 18.8262L19.6649 18.4514C20.0709 18.0454 20.0709 17.3895 19.6649 16.9522L15.6045 12.8918C15.1985 12.517 14.5426 12.517 14.1365 12.9231Z"
                                                                    fill="#DD655B" />
                                                            </svg>
                                                            <span><?php echo implode(' / ', $formatted_telephones); ?></span>
                                                        </p>
                                                        <?php
                                                    }
                                                    ?>
                                                    ...
                                                    if (have_rows('phone_number')) {
                                                        ...
                                                        <p>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="21"
                                                                ...
                                                                <path
                                                                    d="M9.60889 0.5H1.88651C0.844618 0.5 0 1.34462 0 2.38651V18.6135C0 19.6554 0.844618 20.5 1.88651 20.5H9.60889C10.6508 20.5 11.4954 19.6554 11.4954 18.6135V2.38651C11.4954 1.34462 10.6508 0.5 9.60889 0.5Z"
                                                                    fill="#43567C" />
                                                                <path
                                                                    d="M10.525 2.98885V17.3254C10.5252 17.3678 10.5169 17.4098 10.5008 17.4491C10.4847 17.4883 10.461 17.524 10.431 17.554C10.4011 17.5841 10.3656 17.608 10.3264 17.6243C10.2872 17.6406 10.2452 17.6491 10.2028 17.6492H1.29488C1.25245 17.6491 1.21046 17.6406 1.1713 17.6243C1.13214 17.608 1.09658 17.5841 1.06666 17.554C1.03673 17.524 1.01303 17.4883 0.996899 17.4491C0.98077 17.4098 0.972532 17.3678 0.972658 17.3254V2.98885C0.972532 2.94642 0.98077 2.90439 0.996899 2.86515C1.01303 2.82591 1.03673 2.79024 1.06666 2.76016C1.09658 2.73009 1.13214 2.70621 1.1713 2.68989C1.21046 2.67357 1.25245 2.66512 1.29488 2.66504H10.2028C10.2452 2.66512 10.2872 2.67357 10.3264 2.68989C10.3656 2.70621 10.4011 2.73009 10.431 2.76016C10.461 2.79024 10.4847 2.82591 10.5008 2.86515C10.5169 2.90439 10.5252 2.94642 10.525 2.98885Z"
                                                                    fill="#8CC0F3" />
                                                                <path
                                                                    d="M7.07851 1.70174H4.41264C4.37054 1.70174 4.33016 1.68501 4.3004 1.65525C4.27063 1.62548 4.25391 1.58511 4.25391 1.54301C4.25391 1.50091 4.27063 1.46054 4.3004 1.43077C4.33016 1.401 4.37054 1.38428 4.41264 1.38428H7.07851C7.12061 1.38428 7.16098 1.401 7.19075 1.43077C7.22052 1.46054 7.23724 1.50091 7.23724 1.54301C7.23724 1.58511 7.22052 1.62548 7.19075 1.65525C7.16098 1.68501 7.12061 1.70174 7.07851 1.70174Z"
                                                                    fill="#2F3A5A" />
                                                                <path
                                                                    d="M6.77194 18.502H4.7232C4.64308 18.502 4.57812 18.5669 4.57812 18.647V19.4332C4.57812 19.5133 4.64308 19.5783 4.7232 19.5783H6.77194C6.85206 19.5783 6.91701 19.5133 6.91701 19.4332V18.647C6.91701 18.5669 6.85206 18.502 6.77194 18.502Z"
                                                                    fill="#2F3A5A" />
                                                                <g opacity="0.5">
                                                                    <path
                                                                        d="M9.64494 2.66504L0.96875 17.1809V14.9142L8.28939 2.66504H9.64494Z"
                                                                        fill="#E1E6E9" />
                                                                    <path
                                                                        d="M10.5202 3.36035V4.4921L2.65666 17.6492H1.98047L10.5202 3.36035Z"
                                                                        fill="#E1E6E9" />
                                                                </g>
                                                            </svg>
                                                            <span> <?php echo implode(' / ', $formatted_phone_numbers); ?></span>
                                                        </p>
                                                        <?php
                                                    }
                                                    ?>
