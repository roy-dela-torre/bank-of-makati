                ...
                <div class="col-xl-5 col-lg-6 col-md-12">
                    <div class="footer_content">
                        <a href="<?php echo $home_url; ?>" target="_blank" rel="noopener noreferrer">
                            <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/global/logo.png" alt="Bank of Makati" class="logo">
                        </a>
                ...
                <div class="col-xl-5 col-lg-6 col-md-12">
                    <div class="footer_quick_links">
                        <div class="quick_links">
                            ...
                            <a href="<?php echo $home_url; ?>/about-bmi" target="_blank" rel="noopener noreferrer">About BMI</a>
