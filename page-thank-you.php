<?php get_header(); ?>
<section class="thank_you h-100 d-flex align-items-center" style="background:url('<?php echo get_stylesheet_directory_uri(); ?>/assets/images/global/background_template.jpg')no-repeat center center/cover;max-height: 900px">
    <div class="wrapper">
